      ...
      >
        ...
        <div className="px-5 pt-6 pb-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-bold text-white tracking-wider">REALM GROUP GLOBAL</p>
        ...
        {data && (
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8" id="section-top">
            ...
            <div className="flex items-start justify-between mb-8" data-testid="header">
              <div>
                <h1 className="text-4xl sm:text-5xl font-bold text-white uppercase tracking-[0.15em] leading-none">
                  REALM PULSE DAILY
                </h1>
                <p className="text-sm font-semibold text-[#D4A017] uppercase tracking-[0.2em] mt-2">
